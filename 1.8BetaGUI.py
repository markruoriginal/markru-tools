...
def main():
    root = tk.Tk()
    root.title("GUI MarkRuTools 1.8 Beta ")
    ...
    # Новая кнопка "Info"
    info_button = tk.Button(root, text="Info", command=lambda: messagebox.showerror("MarkRuTools GUI 1.8", message="This is a test version of MarkRuTools GUI 1.8"), **buttons_params)
